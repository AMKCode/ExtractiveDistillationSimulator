...
class TestTernaryMargulesAcetaldehydeMethanolWater_withjacob(unittest.TestCase):
    ...
    def test_RandomConvert_ytox_from_convert_xtoy_output_ternary_case(self):
        everfailed = 0
        total = 2000
        passed_path = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_ytox_from_convert_xtoy_passed.csv'
        failed_path = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_ytox_from_convert_xtoy_failed.csv'
        plot_path = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_ytox_from_convert_xtoy_graph.png'
    ...
    def test_RandomConvert_xtoy_from_convert_ytox_output_ternary_case(self):
        passed_path = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_xtoy_from_convert_ytox_passed.csv'
        failed_path = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_xtoy_from_convert_ytox_failed.csv'
        plot_path = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_xtoy_from_convert_ytox_graph.png'
        everfailed = 0
        total = 2000
    ...
    def test_computeTxy(self):
        failed_path1 = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_ytox_from_convert_xtoy_failed.csv'
        compute_sys_eq(self.vlemodel, failed_path = failed_path1)
        failed_path2 = './src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_xtoy_from_convert_ytox_failed.csv'
