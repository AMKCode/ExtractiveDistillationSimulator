...
class TestPhasePortraitsDoubleFeed(unittest.TestCase):
    ...
    def testplotresidue(self):
        ...
        rcm.plot_residue_curve(ax,[0,8],data_points=100,init_comps = [ 
                                                 np.array([0.6,0.1,0.3]),
                                                 np.array([0.1,0.1,0.8]),
                                                 np.array([0.2,0.5,0.3]),
                                                 np.array([0.3,0.3,0.4]),
                                                 np.array([0.8,0.1,0.1]),
                                                 np.array([0.8,0.19,0.01]),
                                                 np.array([0.1,0.89,0.01]),
                                                 np.array([0.1,0.8,0.1]),
                                                 np.array([0.95,0.02,0.03]),
                                                 np.array([0.7,0.29,0.01])
                                                 ])
    ...
    def testplotrect(self):
        ...
        fig, ax = plt.subplots(1,1,figsize= (7,7))
        rcm.plot_rect_portrait(ax,[0,7],data_points=100,
                                   init_comps = [ 
                                                 np.array([0.6,0.1,0.3]),
                                                 np.array([0.1,0.1,0.8]),
                                                 np.array([0.2,0.5,0.3]),
    ...
    def testplotstrip(self):
        rcm = phase_portraits(self.vle_model, self.distil_model)
        fig, ax = plt.subplots(1,1,figsize= (7,7))
        rcm.plot_strip_portrait(ax,[0,7],data_points=100,
                                   init_comps = [ 
                                                 np.array([0.6,0.1,0.3]),
                                                 np.array([0.1,0.1,0.8]),
                                                 np.array([0.2,0.5,0.3]),
        ...
        ax.set_title("Strip Phase Portrait")
        plt.show()

    def testplotmiddle(self):
        rcm = phase_portraits(self.vle_model, self.distil_model)
        fig, ax = plt.subplots(1,1,figsize= (7,7))
        rcm.plot_middle_portrait(ax,[0,7],data_points=100,
                                   init_comps = [ 
                                                 np.array([0.6,0.1,0.3]),
                                                 np.array([0.1,0.1,0.8]),
                                                 np.array([0.2,0.5,0.3]),
        ...
        ax.set_title("Middle Phase Portrait")
        plt.show()
