...
class TestTernaryMargulesAcetaldehydeMethanolWater(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.vlemodel = MargulesModelTernary(3,P_sys,A_,["A","B","C"],[Acet_antoine,H2O_antoine, Methanol_antoine])
    ...
    def test_RandomConvert_ytox_from_convert_xtoy_output_ternary_case(self):
        ...
        with open('./src/Tests/test_results/Margules_acetMethanolWater/convert_ytox_from_convert_xtoy_passed.csv', 'w', newline='') as csvfile, \
            open('./src/Tests/test_results/Margules_acetMethanolWater/convert_ytox_from_convert_xtoy_failed.csv', 'w', newline='') as failed_csvfile:
    ...
    def test_RandomConvert_xtoy_from_convert_ytox_output_ternary_case(self):
        everfailed = False
        with open('./src/Tests/test_results/Margules_acetMethanolWater/convert_xtoy_from_convert_ytox_passed.csv', 'w', newline='') as csvfile, \
            open('./src/Tests/test_results/Margules_acetMethanolWater/convert_xtoy_from_convert_ytox_failed.csv', 'w', newline='') as failed_csvfile:
