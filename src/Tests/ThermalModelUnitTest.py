...
from utils.plot_points_ternary_debug import *

def generate_point_system_random_sum_to_one():
    ...
    # Generate a point from a Dirichlet distribution with alpha = [1, 1, 1]
    x = np.random.dirichlet([1, 1, 1])
    
    # Ensure the sum is 1 by normalizing
...
class TestTernaryMargulesAcetaldehydeMethanolWater_nojacob(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.vlemodel = MargulesModelTernary(3,P_sys,A_,["A","B","C"],[Acet_antoine,H2O_antoine, Methanol_antoine],False)
    ...
    def test_RandomConvert_ytox_from_convert_xtoy_output_ternary_case(self):
        ...
        with open('./src/Tests/test_results/Margules_acetMethanolWater_no_jacob/convert_ytox_from_convert_xtoy_passed.csv', 'w', newline='') as csvfile, \
            open('./src/Tests/test_results/Margules_acetMethanolWater_no_jacob/convert_ytox_from_convert_xtoy_failed.csv', 'w', newline='') as failed_csvfile:
            ...
            for i in range(10000):
                x1,x2,x3 = generate_point_system_random_sum_to_one()
    ...
    def test_RandomConvert_xtoy_from_convert_ytox_output_ternary_case(self):
        everfailed = False
        with open('./src/Tests/test_results/Margules_acetMethanolWater_no_jacob/convert_xtoy_from_convert_ytox_passed.csv', 'w', newline='') as csvfile, \
            open('./src/Tests/test_results/Margules_acetMethanolWater_no_jacob/convert_xtoy_from_convert_ytox_failed.csv', 'w', newline='') as failed_csvfile:
            ...
            for i in range(10000):
                y1,y2,y3 = generate_point_system_random_sum_to_one()
...
class TestTernaryMargulesAcetaldehydeMethanolWater_withjacob(unittest.TestCase):
    def setUp(self) -> None:
        A_ = np.array([[0, -316.699, 350.100], [-384.657,0, 307.000],[290.200,143.00,0]])
        P_sys = 1
        ...
        self.vlemodel = MargulesModelTernary(3,P_sys,A_,["A","B","C"],[Acet_antoine,H2O_antoine, Methanol_antoine],True)
    ...
    def test_RandomConvert_ytox_from_convert_xtoy_output_ternary_case(self):
        # Open a CSV file for writing
        with open('./src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_ytox_from_convert_xtoy_passed.csv', 'w', newline='') as csvfile, \
            open('./src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_ytox_from_convert_xtoy_failed.csv', 'w', newline='') as failed_csvfile:
    ...
    def test_RandomConvert_xtoy_from_convert_ytox_output_ternary_case(self):
        everfailed = False
        with open('./src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_xtoy_from_convert_ytox_passed.csv', 'w', newline='') as csvfile, \
            open('./src/Tests/test_results/Margules_acetMethanolWater_with_jacob/convert_xtoy_from_convert_ytox_failed.csv', 'w', newline='') as failed_csvfile:
