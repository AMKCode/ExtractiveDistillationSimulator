...
class TestTernaryMargulesAcetaldehydeMethanolWater_no_jacob(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.vlemodel = MargulesModel(num_comp=3,P_sys=P_sys,A_=A_,comp_names=["Acet","MeOH","H2O"],partial_pressure_eqs=[Acet_antoine, Methanol_antoine, H2O_antoine],use_jacob=False)
